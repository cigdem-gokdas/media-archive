...
def find_link(movie_name):
    ...
    with sync_playwright() as pw:
        ...
        try:
            ...
            page.wait_for_selector("ul.ipc-metadata-list li.find-result-item", timeout=10000)
            first_result=page.locator("ul.ipc-metadata-list li.find-result-item a").first
