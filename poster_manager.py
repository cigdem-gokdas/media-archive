"""This extracts posters from imbd."""
import re
    ...
    def download_poster(self, poster_url, title):
        ...
        try:
            ...
            if not sanitized_title:
                print(
                    f"✗ Could not create valid filename from title: '{title}'")
                return False
            ...
            response = self.session.get(
                poster_url, headers=headers, timeout=15, allow_redirects=True, stream=True)
